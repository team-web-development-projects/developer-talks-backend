...
public class ReportController {
    ...
    @PostMapping("/user")
    public ResponseEntity<Void> submitUserReport(@RequestParam String nickname, @RequestBody ReportDetailRequestDto dto) {
    ...
    @PostMapping("/post")
    public ResponseEntity<Void> submitPostReport(@RequestParam Long id, @RequestBody ReportDetailRequestDto dto) {
