...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.httpBasic().disable()
                ...
                .requestMatchers(HttpMethod.GET, "/post/**", "/comment/**", "/questions/**", "/answers/**",
                        "/news", "/users/userid", "/announcements/**", "/announcements/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/users/profile/image", "/visitors/increase").permitAll()
